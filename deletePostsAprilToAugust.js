/**
 * Delete Posts from April 2025 to August 27, 2025
 * Deletes all posts from 2025-04-01 to 2025-08-27 from both WordPress and MongoDB
 */
...
async function deletePosts(dryRun = true) {
  try {
    console.log('\n📅 Searching for posts from April 1, 2025 to August 27, 2025...\n')

    // Query for posts from April 1, 2025 to August 27, 2025
    ...
    console.log(`Found ${postsToDelete.length} posts from April 1, 2025 to August 27, 2025\n`)
    ...
    if (postsToDelete.length > 10) {
      console.log(`... and ${postsToDelete.length - 10} more posts\n`)
    }
    console.log('─'.repeat(80))
    ...
    for (let i = 0; i < postsToDelete.length; i++) {
      ...
      // Only log every 10th post to reduce console spam
      if (i % 10 === 0 || i === postsToDelete.length - 1) {
    ...
    // Summary
    console.log('\n' + '═'.repeat(80))
    console.log('DELETION SUMMARY - April 1 to August 27, 2025')
    console.log('═'.repeat(80))
