...
const thenewsguruEntertainment = {
    siteUrl: [
...
const premiumtimesngEntertainment = {
   siteUrl: [
...
const yabaleftonlineEntertainment = {
  siteUrl: ['https://www.yabaleftonline.ng/entertainment-news/'],
  listings: {
...
const siteNames = [
  dailypost, 
  dailypostEntertainment, 
  dailypostSports, 
  leadership, 
  leadershipEntertainment, 
  gistlover, 
  gistloverEntertainment, 
  gistloverLifestyle, 
  gistloverGist, 
  notJustOk, 
  notJustOkSong,
  notJustOkSports,
  naijanews, 
  naijanewsEntertainment, 
  naijanewsGists, 
  naijanewsSports,
  gistreel,
  gistreelSports,
  gistreelEntertainment,
  gistreelGists,
  guardian, 
  guardianSports,
  guardianLifestyle,
  ...
  pulseSports,
  thenewsguru,
  thenewsguruEntertainment,
  thenewsguruSports,  
  premiumtimesng, 
  premiumtimesngEntertainment,
  premiumtimesngLifestyle,
  premiumtimesngHealth,
  premiumtimesngFood,
  premiumtimesngSports,
  yabaleftonlineEntertainment,
  yabaleftonlineGists,
  brila, 
  brilaOther, 
  healthza, 
